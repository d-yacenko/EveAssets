...
public class Blueprint_1400mm_Howitzer_Artillery_II_ extends BlueprintII {

	public Blueprint_1400mm_Howitzer_Artillery_II_(int volume) {
		this.volume=volume;
	...
	public String getName() {
		return "1400mm Howitzer Artillery II Blueprint";
	}	
