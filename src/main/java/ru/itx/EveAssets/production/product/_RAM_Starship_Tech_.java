...
import ru.itx.EveAssets.production.blueprint.Blueprint_RAM_Starship_Tech_;
...
public class _RAM_Starship_Tech_ extends Prototype {
	public _RAM_Starship_Tech_(int volume) {
		this.volume = volume;
		...
		blueprint = new Blueprint_RAM_Starship_Tech_(1);
		isElementary = false;
	}
	
	@Override
	public String getName() {
		return "R.A.M.- Starship Tech";
	}	
}
