...
import ru.itx.EveAssets.production.blueprintII.Blueprint_Huginn_;
...
public class _Huginn_ extends Prototype {

	
	public _Huginn_(int volume) {
		this.volume=volume;
		materials=new ArrayList<Item>();
		materials.add(new _Bellicose_(1));
		materials.add(new _RAM_Starship_Tech_(18));
		materials.add(new _Plasma_Thruster_(60));
		...
		blueprint=new Blueprint_Huginn_(1);
		isElementary=false;
	}
	@Override
